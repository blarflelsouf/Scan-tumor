...
sdir=r"/home/landsberg/code/blarflelsouf/scan-tumor/raw_data/archive/Training_Binary"
df=make_dataframe(sdir)
print (df.head())
print ('length of dataframe is ',len(df))

augdir=r"/home/landsberg/code/blarflelsouf/scan-tumor/raw_data/archive/Augmented_Training_Binary" # directory to store the images if it does not exist it will be created
n=12000 # if the class had N image samples in the sdir, if N<n than in augdir n-N augmented images will be created
img_size=(150,150) # image size (height,width) of augmented images
